...
contextBridge.exposeInMainWorld("cleanmark", {
  ...
  loadRemoteImage: (url) => ipcRenderer.invoke("remote-image:load", url),
  ...
  getConversionCapabilities: () => ipcRenderer.invoke("conversion:get-capabilities"),
  chooseConversionInput: () => ipcRenderer.invoke("conversion:choose-input"),
  chooseConversionOutput: (target, baseName) => ipcRenderer.invoke("conversion:choose-output", { target, baseName }),
  ...
  downloadOcrLanguage: (language) => ipcRenderer.invoke("conversion:download-ocr-language", language),
  openConversionComponentPage: (component) => ipcRenderer.invoke("conversion:open-component-page", component),
  openConversionResult: (filePath) => ipcRenderer.invoke("conversion:open-result", filePath),
  showConversionResult: (filePath) => ipcRenderer.invoke("conversion:show-result", filePath),
  ...
  reload: (filePath) => ipcRenderer.send("window:reload", filePath || null),
  ...
  onConversionProgress: (callback) => subscribe("conversion:progress", callback),
  onConversionComponentProgress: (callback) => subscribe("conversion:component-progress", callback),
